...
{
    public class BankAccountOwnerService : IBankAccountOwnerService
    {
        private readonly HttpClient httpClient ;
        public BankAccountOwnerService(HttpClient httpClient)
        {
            this.httpClient = httpClient;
        }
        public async Task<List<TblBankAccountOwner>> GetBankAccountOwner()
        {
            return await httpClient.GetFromJsonAsync<List<TblBankAccountOwner>>("api/BankAccountOwner/GetBankAccountOwner");
        }
