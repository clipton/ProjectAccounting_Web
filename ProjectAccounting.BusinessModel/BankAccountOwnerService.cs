...
namespace ProjectAccounting.BusinessModel
{
    public class BankAccountOwnerService : IBankAccountOwnerService
    {
        ...
        public BankAccountOwnerService(ProjectAccountingContext projectAccountingContext)
        {
            this._projectAccountingContext = projectAccountingContext;
        }
        public List<TblBankAccountOwner> GetBankAccountOwner()
        { 
            var data = _projectAccountingContext.TblBankAccountOwners.ToList();
            return data;
        }
